...
def estimate_yaw(path='', start_date='2018-06-02',
    ...
    file = open("/home/pgidarakos/gprc_api_python/select_bins_yaw_scaler.pickle",'rb')
    scaler = pickle.load(file)
    print('scale')
    
    
    f = open("/home/pgidarakos/gprc_api_python/model_bins.pickle.z",'rb')
    file_content = f.read()
    f.close()
